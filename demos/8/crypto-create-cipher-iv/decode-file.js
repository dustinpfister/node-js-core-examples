...
key = Buffer.from(process[3] || '313233342d737061636562616c6c730000000000000000000000000000000000','hex'),
iv = Buffer.from(process[4] || '00000000000000000000000000000000','hex');
